...
let website = "/fsharpBook"

let githubLink = "http://github.com/Update GitHome in build.fsx/fsharpBook"

// Specify more information about your project
let info =
  [ "project-name", "fsharpBook"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/fsharpBook" ]
